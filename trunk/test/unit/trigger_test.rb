...
class TriggerTest < Test::Unit::TestCase
  ...
  def test_enter
    ...
    assert_equal "entergeofen_2", reading.event_type
    
    reading = save_reading(32.940956, -96.822224, 1)
    assert_equal "exitgeofen_1", reading.event_type
    
    reading = save_reading(32.8330956, -96.822224, 1)
    assert_equal "exitgeofen_2", reading.event_type
    
    reading = save_reading(38.898748, -77.037684, 1)
    assert_equal "entergeofen_3", reading.event_type
    
     reading = save_reading(32.8330956, -96.822224, 1)
    assert_equal "exitgeofen_3", reading.event_type
  end
